...
FAHClient -v --user=Anonymous --team=0 --gpu=false --gui-enabled=false --cpus=1 --chdir=/tmp --log-to-screen=true --http-addresses=127.0.0.1:7396 --command-address=127.0.0.1 --max-packet-size=small
