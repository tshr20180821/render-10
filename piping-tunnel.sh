...
do
  ...
  piping-tunnel server --verbose 5 --host 127.0.0.1 --pass ${PIPING_PASSWORD} --port ${TARGET_PORT} --symmetric --server https://piping.glitch.me/ ${PIPING_PASSWORD}req ${PIPING_PASSWORD}res
