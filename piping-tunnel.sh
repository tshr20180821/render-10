...
do
  ...
  piping-tunnel server --verbose 5 --host 127.0.0.1 --port ${TARGET_PORT} --server https://ppng.io --cipher-type=openssl-aes-256-ctr --symmetric --pass ${PIPING_PASSWORD} ${KEYWORD}req ${KEYWORD}res
